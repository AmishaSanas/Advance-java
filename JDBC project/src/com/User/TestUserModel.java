...
public class TestUserModel {
	 ...
	 * UserBean bean = new UserBean();
	 * 
	 * bean.setId(12); bean.setFirstName("Tarun"); bean.setLastName("Verma");
	 * bean.setLoginId("Tarun@gmail.com"); bean.setPassword("tarun123");
	 * bean.setAddress("indore"); bean.setDob(sdf.parse("2000-02-02"));
	 * 
	 * model.update(bean);
	 * 
	 * }
