...
import com.mchange.v2.c3p0.ComboPooledDataSource;
	...
	public final class JDBCDataSource {
		...
		// step 2 make self type of private static variable & static variable have one copy/memory in life time
		...
		public static JDBCDataSource getInstance() {
			...
			if (datasource == null) {
				...
				datasource.cpds = new ComboPooledDataSource(); //use for getting connection
